Tapjoyad::Application.routes.draw do
  namespace :job do
    ...
    match 'master_cache_support_request_stats(/index)' => 'master_cache_support_request_stats#index'
    ...
    match 'master_daily_partner_stats(/index)' => 'master_daily_partner_stats#index'
    ...
    match 'master_hourly_partner_stats(/index)' => 'master_hourly_partner_stats#index'
