...
Rails::Initializer.run do |config|
  ...
  config.gem 'oa-core', :version => '0.3.0'
  config.gem 'mime-types', :version => '1.16', :lib => 'mime/types'
  config.gem 'rest-client', :version => '1.6.7'
  config.gem 'oa-basic', :version => '0.3.0'
  config.gem 'net-ldap', :version => '0.2.2'
  config.gem 'pyu-ruby-sasl', :version => '0.0.3.2', :lib => 'sasl/base'
  config.gem 'rubyntlm', :version => '0.1.1', :lib => 'net/ntlm'
  config.gem 'systemu', :version => '2.2.0'
  config.gem 'macaddr', :version => '1.4.0'
  config.gem 'log4r', :version => '1.1.9'
  config.gem 'XMLCanonicalizer', :version => '1.0.1'
  config.gem 'oa-enterprise', :version => '0.3.0'
  config.gem 'oa-more', :version => '0.3.0'
  config.gem 'oauth', :version => '0.4.5'
  config.gem 'oauth2', :version => '0.5.0'
  config.gem 'oa-oauth', :version => '0.3.0'
  config.gem 'ruby-openid', :version => '2.1.8', :lib => 'openid'
  config.gem 'rack-openid', :version => '1.3.1', :lib => 'rack/openid'
  config.gem 'ruby-openid-apps-discovery', :version => '1.2.0', :lib => 'gapps_openid'
  config.gem 'oa-openid', :version => '0.3.0'
