authorization do
  ...
  role :partner do
    ...
    has_permission_on :dashboard_offers, :to => [ :index, :new, :create, :edit, :update, :toggle, :percentile, :preview ]
    ...
    has_permission_on :dashboard_billing, :to => [ :index, :add_funds, :transfer_funds, :payout_info, :update_payout_info, :create_transfer, :create_order, :export_statements, :export_orders, :export_payouts, :export_adjustments, :forget_credit_card, :payment_history ]
  ...
  role :customer_service do
    ...
    has_permission_on :dashboard_tools, :to => [:gamers, :resolve_clicks, :device_info, :update_device, :send_currency_failures, :view_conversion_attempt]
  ...
  role :account_mgr do
    ...
    has_permission_on :dashboard_currency_sales, :to => [ :index, :edit, :update, :new, :create, :destroy ]
    ...
    has_permission_on :dashboard_partners, :to => [ :index, :show, :edit, :make_current, :manage, :stop_managing, :mail_chimp_info, :update, :managed_by, :by_country, :new_transfer, :create_transfer, :new_dev_credit, :create_dev_credit, :reporting, :agency_api, :set_tapjoy_sponsored, :set_unconfirmed_for_payout ]
