...
MEMCACHE_SERVERS = [ 'acs-prod.fqfjqv.1xmj.use1.acsvc.amazonaws.com',
                     'acs-prod.fqfjqv.1xmk.use1.acsvc.amazonaws.com',
                     'acs-prod.fqfjqv.1xml.use1.acsvc.amazonaws.com',
                     'acs-prod.fqfjqv.1xmm.use1.acsvc.amazonaws.com' ]
