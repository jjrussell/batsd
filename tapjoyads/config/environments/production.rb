...
SDB_MEMCACHE_SERVERS = [
  'riakcache-cache-0.tapjoy.local',
...
RIAK_NODES = [{:host => 'cluster-1.us-east-e.riak.tapjoy.net'},
              ...
              {:host => 'cluster-23.us-east-e.riak.tapjoy.net'},
              {:host => 'cluster-24.us-east-e.riak.tapjoy.net'},
              {:host => 'cluster-25.us-east-e.riak.tapjoy.net'},
              {:host => 'cluster-26.us-east-e.riak.tapjoy.net'},
              {:host => 'cluster-27.us-east-e.riak.tapjoy.net'}]

DEVICE_RIAK_NODES = [{:host => 'riakdevices-backup-cluster-0.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-1.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-2.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-3.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-4.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-5.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-6.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-7.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-8.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-9.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-10.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-11.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-12.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-13.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-14.us-east.riak.tapjoy.net'},
                     {:host => 'riakdevices-backup-cluster-15.us-east.riak.tapjoy.net'}]