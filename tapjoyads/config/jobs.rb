JobRunner::Gateway.define do |s|
  ...
  if machine_type == 'jobs' || machine_type == 'test'
    ...
    s.add_job 'queue_failed_device_saves', :interval => 30.seconds
    ...
    s.add_job 'master_global_daily_stats', :hourly => 5.minutes
    s.add_job 'master_global_hourly_stats', :hourly => 6.minutes
