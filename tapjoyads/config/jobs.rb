JobRunner::Gateway.define do |s|
  ...
  if machine_type == 'jobs' || machine_type == 'test'
    ...
    s.add_job 'queue_update_monthly_account', :interval => 5.seconds
    ...
    s.add_job 'master_reload_money', :interval => 1.hour
    ...
    s.add_job 'master_update_monthly_account', :daily => 7.hours
  else
