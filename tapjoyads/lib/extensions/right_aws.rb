module RightAws
  class SdbInterface
    ...
    def request_info(request, parser)
      ...
      thread[:sdb_connection] ||= Rightscale::HttpConnection.new(:exception => AwsError, :logger => @logger, :http_connection_read_timeout => 15, :http_connection_retry_count => 1, :http_connection_retry_delay => 5)
