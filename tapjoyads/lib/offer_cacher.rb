  ...
  class << self
    ...
    def cache_offers(save_to_s3 = false)
      Benchmark.realtime do
        ...
        offer_list = Offer.enabled_offers.featured.non_rewarded.free_apps.non_video_offers.for_offer_list + Offer.enabled_offers.nonfeatured.non_rewarded.free_apps.non_video_offers.for_offer_list
