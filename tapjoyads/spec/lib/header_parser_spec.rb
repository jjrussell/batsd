...
describe HeaderParser do
  ...
  describe '.os_versions' do
    context 'given a header with a known user-agent' do
      it 'returns the appropriate os_version' do
  ...
  describe '.locale' do
    context 'given a known accept-language' do
      it 'returns the appropriate language code' do
    ...
    context 'given an unknown accept-language' do
      it 'returns nil' do
