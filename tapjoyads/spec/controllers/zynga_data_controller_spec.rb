...
describe ZyngaDataController do
  describe '#index' do
    before :each do
      @controller.should_receive(:zynga_authenticate).at_least(:once).and_return(true)
    end
    ...
    context 'valid params' do
      ...
      it 'has instance variable @appstats_list' do
        get(:index, @params)
        assigns(:appstats_list).should == [['zynga_offers', 'zynga_test']]
      end
    end
  end
end
