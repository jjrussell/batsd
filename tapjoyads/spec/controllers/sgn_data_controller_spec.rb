...
describe SgnDataController do
  describe '#index' do
    before :each do
      @controller.should_receive(:sgn_authenticate).at_least(:once).and_return(true)
    end
    ...
    context 'valid params' do
      before :each do
        ...
        Appstats.stub(:new).and_return('sgn_test')
      end
      ...
      it 'has instance variable @appstats_list' do
        get(:index, @params)
        assigns(:appstats_list).should == [[@offer, 'sgn_test']]
      end
    end
  end
end
