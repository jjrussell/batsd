...
describe BrooklynPacketDataController do
  describe '#index' do
    before :each do
      @controller.should_receive(:brooklyn_packet_authenticate).at_least(:once).and_return(true)
    end
    ...
    context 'valid params' do
      before :each do
        ...
        Appstats.stub(:new).and_return('brook_test')
      end
      ...
      it 'has instance variable @appstats_list' do
        get(:index, @params)
        assigns(:appstats_list).should == [[@offer, 'brook_test']]
      end
    end
  end
end
