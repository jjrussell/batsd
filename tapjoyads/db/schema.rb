...
ActiveRecord::Schema.define(:version => 20120629140237) do
  ...
  create_table "action_offers", :id => false, :force => true do |t|
    ...
    t.string   "negative_prerequisite_offer_id", :limit => 36
  end
  ...
  add_index "action_offers", ["negative_prerequisite_offer_id"], :name => "index_action_offers_on_negative_prerequisite_offer_id"
  ...
  add_index "generic_offers", ["negative_prerequisite_offer_id"], :name => "index_generic_offers_on_negative_prerequisite_offer_id"
  add_index "generic_offers", ["partner_id"], :name => "index_generic_offers_on_partner_id"
  add_index "generic_offers", ["prerequisite_offer_id"], :name => "index_generic_offers_on_prerequisite_offer_id"
  ...
  add_index "offers", ["negative_prerequisite_offer_id"], :name => "index_offers_on_negative_prerequisite_offer_id"
  ...
  add_index "survey_offers", ["negative_prerequisite_offer_id"], :name => "index_survey_offers_on_negative_prerequisite_offer_id"
  ...
  add_index "video_offers", ["negative_prerequisite_offer_id"], :name => "index_video_offers_on_negative_prerequisite_offer_id"
