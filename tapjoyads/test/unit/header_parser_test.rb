...
class HeaderParserTest < ActiveSupport::TestCase
  context "The HeaderParser" do
    ...
    should "parse os_version from known user-agents" do
      ...
      assert_equal '4.3.5', HeaderParser.os_version(@user_agents[:ipad_ios_4])
      assert_equal '5.0',   HeaderParser.os_version(@user_agents[:ipad_ios_5])
    ...
    should "parse device_type from known user-agents" do
      ...
      assert_equal 'ipad',    HeaderParser.device_type(@user_agents[:ipad_ios_4])
      assert_equal 'ipad',    HeaderParser.device_type(@user_agents[:ipad_ios_5])
