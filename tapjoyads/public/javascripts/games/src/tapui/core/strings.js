(function(Tap){
  ...
  Tap.String = {
    ...
    format: function(string){
      var args = Tap.Array.toArray(arguments, 1);
      return string.replace(Tap.RegEx.format, function(m, i) {
        return args[i];
      });
    },    
    ...
    escape: function(string) {
      return string.replace(Tap.RegEx.escape, "\\$1");
    },

    escapeRegex: function(string) {
      return string.replace(Tap.RegEx.escapeRegex, "\\$1");
    },
