module GetOffersHelper
  ...
  def get_previous_link
    ...
    link_to("&laquo; Previous #{@max_items}", "/get_offers/webpage?#{tmp_params.to_query}")
  end
  ...
  def get_next_link
    ...
    link_to("Next #{[@more_data_available, @max_items].min} &raquo;", "/get_offers/webpage?#{tmp_params.to_query}")
  end
