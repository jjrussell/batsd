module PressHelper
  ...
  def about_blurb(company=:tapjoy)
    if company == :offerpal
      ...
      concat("Tapjoy is the leading platform company for social and mobile applications. The company's turnkey alternative payment platform enables developers to significantly increase their monetization rates when selling virtual goods or premium digital assets, while its cross-platform distribution services provide massive reach and cost-effective user acquisition on the leading social, mobile and gaming platforms. The company is headquartered in San Francisco, California. Investors include Rho Ventures, Interwest Capital, North Bridge Venture Partners, and D. E. Shaw Ventures. For more information, visit #{link_to_tapjoy}.")
    end
    concat("<br/><br/>")
  end
end
