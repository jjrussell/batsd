class Dashboard::NonRewardedController < Dashboard::DashboardController
  ...
  def update
    ...
    if permitted_to?(:edit, :dashboard_statz)
      allowed_attr_names += [ :tapjoy_enabled, :hide_rewarded_app_installs, :minimum_hide_rewarded_app_installs_version, :disabled_offers, :max_age_rating, :only_free_offers, :send_offer_data, :ordinal, :rev_share_override, :offer_filter_selections, :use_offer_filter_selections ]
    end
