class Dashboard::CurrenciesController < Dashboard::DashboardController
  ...
  def update
    ...
    if permitted_to?(:edit, :dashboard_statz)
      safe_attributes += [:disabled_offers, :max_age_rating, :only_free_offers, :ordinal, :hide_rewarded_app_installs, :minimum_hide_rewarded_app_installs_version, :tapjoy_enabled, :rev_share_override, :send_offer_data, :conversion_rate_enabled, :offer_filter_selections, :use_offer_filter_selections]
    end
