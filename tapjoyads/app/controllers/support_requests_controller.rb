...
private
  ...
  def find_incomplete_offers
    conditions = ActiveRecord::Base.sanitize_conditions("udid = ? and currency_id = ? and clicked_at > ? and manually_resolved_at is null", params[:udid], params[:currency_id], 30.days.ago.to_f)
