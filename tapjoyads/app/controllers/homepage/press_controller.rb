class Homepage::PressController < WebsiteController
  ...
  def index
    @press_list = [
      ...
      [ "3.11.2009 ", "Offerpal Media Partners with Aeria Games to Monetize Virtual Currency, Increase User Engagement", "200903110-partner-aeria-games", ],
      [ "2.17.2009", "Offerpal Media Secures $15 Million in Financing to Drive Growth and Continued Innovation in Monetizing the Social Web", "http://offerpalmedia.com/Offerpal_SeriesB_Funding.php", ],
