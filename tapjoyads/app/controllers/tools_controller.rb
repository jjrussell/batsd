class ToolsController < WebsiteController
  ...
  def failed_sdb_saves
    ...
    SimpledbResource.get_domain_names.each do |domain_name|
      ...
      skipped_this_hour_count     = Mc.get_count("failed_sdb_saves.skipped.#{domain_name}.#{this_hour_key}")
      skipped_last_hour_count     = Mc.get_count("failed_sdb_saves.skipped.#{domain_name}.#{last_hour_key}")
      ...
      @failed_sdb_saves[domain_name] = { :sdb_this_hour => sdb_this_hour_count,
                                         ...
                                         :skipped_this_hour     => skipped_this_hour_count,
                                         :skipped_last_hour     => skipped_last_hour_count }
    end
  end
