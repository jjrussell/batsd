class Apps::CurrenciesController < WebsiteController
  ...
  def update
    ...
    if permitted_to?(:edit, :statz)
      safe_attributes += [:disabled_offers, :max_age_rating, :only_free_offers, :ordinal, :banner_advertiser, :hide_app_installs, :minimum_hide_app_installs_version, :tapjoy_enabled, :show_gallery ]
    end
