  ...
  def index
    alerts = [
      ...
      },
      {
        ...
        :fields => %w( app_id app_name app_platform acct_mgr hr1_UTC hr2_UTC gross_rev_hr1 gross_rev_hr2 gross_rev_difference gross_rev_pct_difference ),
        :recipients_field => :acct_mgr,
      },
      {
