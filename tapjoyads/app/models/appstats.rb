class Appstats
  ...
  def initialize(app_key, options = {})
    ...
    if @granularity == :hourly && @app_key
      @stats['ranks'] = Stats::Ranks.hourly_over_time_range(@app_key, @start_time.utc, @end_time.utc)
    elsif @app_key
      @stats['ranks'] = Stats::Ranks.daily_over_time_range(@app_key, @start_time.utc, @end_time.utc)
    end
