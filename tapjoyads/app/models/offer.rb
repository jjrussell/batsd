class Offer < ActiveRecord::Base
  ...
  json_set_field :device_types, :screen_layout_sizes, :countries, :dma_codes, :region
  memoize :get_device_types, :get_screen_layout_sizes, :get_countries, :get_dma_codes, :get_region
