...
class Offer < ActiveRecord::Base
  ...
  def save_icon!(icon_src_blob)
    ...
    if item_type == 'App' && app.present? && app.primary_app_metadata.present?
      ...
      bucket.objects["icons/256}/#{icon_id}.jpg"].copy_to(AWS::S3::S3Object.new(bucket,"icons/256/#{meta_icon_id}.jpg",  {:acl => :public_read }))
      bucket.objects["icons/114}/#{icon_id}.jpg"].copy_to(AWS::S3::S3Object.new(bucket,"icons/114/#{meta_icon_id}.jpg",  {:acl => :public_read }))
      bucket.objects["icons/57}/#{icon_id}.jpg"].copy_to(AWS::S3::S3Object.new(bucket,"icons/57/#{meta_icon_id}.jpg",  {:acl => :public_read }))
      bucket.objects["icons/57}/#{icon_id}.png"].copy_to(AWS::S3::S3Object.new(bucket,"icons/57/#{meta_icon_id}.png",  {:acl => :public_read }))
      bucket.objects["icons/src}/#{icon_id}.jpg"].copy_to(AWS::S3::S3Object.new(bucket,"icons/src/#{meta_icon_id}.jpg",  {:acl => :public_read }))
