class Conversion < ActiveRecord::Base
  ...
  STAT_TO_REWARD_TYPE_MAP = {
    'offers' => {
      :reward_types => [ 0, 2, 3, 5, 6 ],
      :attr_name    => 'publisher_app_id' },
    ...
    'display_conversions' => {
      :reward_types => [ 1000, 1001, 1002, 1003, 1004, 1005, 1006 ],
      :attr_name    => 'publisher_app_id' },

    'featured_published_offers' => {
      :reward_types => [ 2000, 2001, 2002, 2003, 2004, 2005, 2006 ],
      :attr_name    => 'publisher_app_id' },

    'paid_installs' => {
      :reward_types => [ 0, 1, 2, 3, 5, 6, 2000, 2001, 2002, 2003, 2005, 2006, 3000, 3001, 3002, 3003, 3005, 3006 ],
      :attr_name    => 'advertiser_offer_id' },

    'jailbroken_installs' => {
      :reward_types => [ 4, 2004, 3004 ],
      :attr_name    => 'advertiser_offer_id' },

    'offers_revenue' => {
      :reward_types => [ 0, 2, 3, 5, 6 ],
      :attr_name    => 'publisher_app_id',
      :sum_attr     => :publisher_amount },
    ...
    'installs_spend' => {
      :reward_types => [ 0, 1, 2, 3, 5, 6, 2000, 2001, 2002, 2003, 2005, 2006, 3000, 3001, 3002, 3003, 3005, 3006 ],
      :attr_name    => 'advertiser_offer_id',
      :sum_attr     => :advertiser_amount },

    'tjm_offers' => {
      :reward_types => [ 3000, 3002, 3003, 3005, 3006 ],
      :attr_name    => 'publisher_app_id' },

    'tjm_published_installs' => {
      :reward_types => [ 3001, 3004 ],
      :attr_name    => 'publisher_app_id' },
