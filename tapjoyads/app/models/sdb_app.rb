class SdbApp < SimpledbResource
  ...
  def get_advertiser_app_list(udid, options = {})
    ...
    advertiser_app_list.reject! do |advertiser_app|
      ...
      reject = true if advertiser_app.key == '4445a5be-9244-4ce7-b65d-646ee6050208' and device_app_list.apps['f8751513-67f1-4273-8e4e-73b1e685e83d'] == nil &&  device_app_list.last_run_time('f8751513-67f1-4273-8e4e-73b1e685e83d') > (Time.zone.now - 1.days) 
